...
function computeTotal(items =[],taxPercent=0){
    ...
    const tax=(subtotal+Number(taxPercent||0))
...
// generate a unique number to avoid collisions in the db for the invoice number 
...
export async function getInvoices(req,res){
    ...
    const invoice =(await Invoice.find(q)).toSorted({createdAt:-1}).lean()
